...
class Discriminator(object):
    ...
    def __init__(
            ...
            embedding_size, filter_sizes, num_filters, l2_reg_lambda=0.0, batch_size=32, reference_size=16):
        ...
        with tf.variable_scope('discriminator'):
            ...
            with tf.name_scope("highway-ref"):
                self.h_highway_ref = highway(self.h_pool_flat_ref, self.h_pool_flat_ref.get_shape()[1], 1, 0, scope="highway-ref")
            ...
            with tf.name_scope("output"):
                ...
                for i in range(batch_size):
                    ...
                    for j in range(reference_size):
                        value += cosine_distance(tf.nn.embedding_lookup(self.h_drop, i), tf.nn.embedding_lookup(self.h_drop_ref, j))
                    score.append(value)
